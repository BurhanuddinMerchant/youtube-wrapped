...
export const getProcessedStats = (stats, setSharableData, user) => {
  ...
  const processedData = {
    ...
    duration_per_channel: {
      ...
      all_liked: {},
      all_disliked: {},
      title_helper: 'Most Viewed Channel (secs)',
      info: 'This indicates your most watched channels based on the duraton of the video (secs).',
      unit_liked: 'Secs',
      unit_disliked: 'Secs',
      field: 'Channel Title',
      total_liked: 0,
    ...
    duration_per_language: {
      ...
      all_liked: {},
      all_disliked: {},
      title_helper: 'Most Viewed Language',
      info: 'This indicates your most watched languages based on the duraton of the video (secs).',
      unit_liked: 'Secs',
      unit_disliked: 'Secs',
      field: 'Language',
      total_liked: 0,
    ...
    duration_per_topic: {
      ...
      all_liked: {},
      all_disliked: {},
      title_helper: 'Most Viewed Topic (sec)',
      info: 'This indicates your most watched topics based on the duraton of the video (secs).',
      unit_liked: 'Secs',
      unit_disliked: 'Secs',
      field: 'Topic',
      total_liked: 0,
